...
4. Crie uma nova **branch** e nomeie como `feat/community/seunomedeusuario`: `git checkout -b feat/community/EdmarSantosM`;
    > Exemplo: `git checkout -b feat/community/EdmarSantosM`
...
4. Create a new **branch** and name it as `feat/community/seunomedeusuario`: `git checkout -b feat/community/EdmarSantosM`;
    > Example: `git checkout -b feat/community/EdmarSantosM`
